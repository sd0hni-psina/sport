...
function EventsPage() {
  ...
  return (
    <>
      <PageMeta
        title="Мероприятия"
        description="Городские спортивные мероприятия Атырау"
      />
      <div>
        {/* Шапка */}
...
>
  <div>
    <p className="text-xs font-bold uppercase tracking-wide mb-1" style={{ color: '#F5A623' }}>
      Есть идея?
    </p>
    <p className="font-bold text-white text-lg">Предложи своё мероприятие</p>
    <p className="text-sm mt-1" style={{ color: '#7A8FA8' }}>
      Лучшие идеи горожан мы воплощаем в жизнь
    </p>
  </div>
  <Link
    to="/suggest"
      ...
      <div className="p-4 flex flex-col gap-2.5 flex-1">
        ...
        <div className="flex flex-col gap-1.5 mt-auto">
          ...
          >
            <Clock size={12} />
            <span>
              {format(new Date(event.time_start), "HH:mm · d MMMM", {
                locale: ru,
              })}
            </span>
          </div>
