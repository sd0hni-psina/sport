...
const inputClass =
  "w-full px-3 py-2.5 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white";
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        >
          <h2 className="text-sm font-bold mb-5" style={{ color: "#0D1F3C" }}>
            Основная информация
          </h2>
          <div className="flex flex-col gap-4">
            <div>
              ...
              <input
                ...
                required
                placeholder="Городской забег 5 км"
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                required
                placeholder="СК «Атырау», ул. Азаттык 25"
                className={inputClass}
                style={inputStyle}
              />
            </div>
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              <label className={labelClass} style={labelStyle}>
                Дедлайн отмены (часов до начала)
              </label>
              <input
                type="number"
                name="cancel_deadline_hrs"
                value={form.cancel_deadline_hrs}
                onChange={handleChange}
                min="1"
                className={inputClass}
                style={inputStyle}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={2}
                placeholder="Мастер спорта, 10 лет опыта..."
                className={inputClass}
                style={inputStyle}
              />
            </div>
            <div>
              ...
              <input
                ...
                value={form.prizes}
                onChange={handleChange}
                placeholder="1 место — медаль, 2 место — грамота"
                className={inputClass}
                style={inputStyle}
              />
            </div>
